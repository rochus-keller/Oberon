...
If the receiver of a type bound procedure declaration refers to a parametric type declaration, its actual type parameter must correspond to one of the formal type parameters of the procedure. 
